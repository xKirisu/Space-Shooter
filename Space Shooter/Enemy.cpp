...
void ss::Enemy::initEnemies(sf::Texture& enemy1, sf::Texture& enemy2, sf::Texture& enemy3, sf::Vector2f spawn_points[], int count)
{
    ...
    enemies_prefabs[EnemyType::ALAN] = Enemy(position, enemy1, 55, 0.75, 2);
    enemies_prefabs[EnemyType::BONBON] = Enemy(position, enemy2, 75, 1.75, 3);
    enemies_prefabs[EnemyType::LIPS] = Enemy(position, enemy3, 65, 1.95, 1);
